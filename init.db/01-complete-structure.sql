...
-- Default Packages (from VM old)
INSERT INTO public.billing_packages (id, name, description, price_monthly, price_daily, bandwidth_limit, session_timeout, idle_timeout, is_active) VALUES
(1, 'Paket 100k', 'Internet 7 Mbps - Unlimited', 100000.00, 5000.00, '10M/10M', 3600, 300, true),
(2, 'Paket Standard', 'Internet 20 Mbps - Unlimited', 250000.00, 8000.00, '20M/20M', 3600, 300, true),
(3, 'Paket Premium', 'Internet 50 Mbps - Unlimited', 450000.00, 15000.00, '50M/50M', 3600, 300, true),
(4, 'Paket 125k', 'Internet 10mbps Mbps - Unlimited', 125000.00, 8000.00, '10M/10M', 3600, 300, true),
(5, 'paket test', 's', 1.00, 1.00, '1', 3600, 300, true);

-- Set sequence values
SELECT setval('public.admin_users_id_seq', 5, true);
SELECT setval('public.billing_packages_id_seq', 5, true);
SELECT setval('public.mikrotik_credentials_id_seq', 7, true);
